...
export function ResultsDashboard({
  ...
  return (
    <div className="space-y-6 animate-in">
      ...
      {/* Fun budget summary */}
      {state.funItems && state.funItems.length > 0 && (() => {
        const totalAnnual = state.funItems.reduce((sum, it) =>
          ...
          <div className="card">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
              <div className="metric">
                ...
                <div className="metric-label">Avg Monthly Fun</div>
              </div>
              <div className="metric">
              ...
              <div className="metric">
                <div className="metric-value" style={{ color: 'var(--color-accent)' }}>
                  {state.funItems.length} categories
                </div>
                <div className="metric-label">Planned Items</div>
              </div>
            </div>
          </div>
        )
